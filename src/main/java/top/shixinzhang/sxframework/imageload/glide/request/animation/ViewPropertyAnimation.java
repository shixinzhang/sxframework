...
/**
 * A {@link top.shixinzhang.sxframework.imageload.glide.request.animation.GlideAnimation GlideAnimation} that accepts an interface
...
public class ViewPropertyAnimation<R> implements GlideAnimation<R> {
     ...
     * {@link top.shixinzhang.sxframework.imageload.glide.request.animation.ViewPropertyAnimation.Animator} interface that can apply an animation
     * to a view.
     *
    ...
    /**
     * Always applies the {@link top.shixinzhang.sxframework.imageload.glide.request.animation.ViewPropertyAnimation.Animator} given in the
