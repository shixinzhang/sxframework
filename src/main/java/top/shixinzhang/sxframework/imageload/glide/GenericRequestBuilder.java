...
import top.shixinzhang.sxframework.imageload.glide.load.MultiTransformation;
...
import top.shixinzhang.sxframework.imageload.glide.load.resource.UnitTransformation;
...
import top.shixinzhang.sxframework.imageload.glide.provider.ChildLoadProvider;
import top.shixinzhang.sxframework.imageload.glide.provider.LoadProvider;
import top.shixinzhang.sxframework.imageload.glide.request.FutureTarget;
import top.shixinzhang.sxframework.imageload.glide.request.GenericRequest;
import top.shixinzhang.sxframework.imageload.glide.request.Request;
import top.shixinzhang.sxframework.imageload.glide.request.RequestCoordinator;
import top.shixinzhang.sxframework.imageload.glide.request.RequestFutureTarget;
import top.shixinzhang.sxframework.imageload.glide.request.RequestListener;
import top.shixinzhang.sxframework.imageload.glide.request.ThumbnailRequestCoordinator;
import top.shixinzhang.sxframework.imageload.glide.request.animation.GlideAnimationFactory;
import top.shixinzhang.sxframework.imageload.glide.request.animation.NoAnimation;
import top.shixinzhang.sxframework.imageload.glide.request.animation.ViewAnimationFactory;
import top.shixinzhang.sxframework.imageload.glide.request.animation.ViewPropertyAnimation;
import top.shixinzhang.sxframework.imageload.glide.request.animation.ViewPropertyAnimationFactory;
import top.shixinzhang.sxframework.imageload.glide.request.target.PreloadTarget;
import top.shixinzhang.sxframework.imageload.glide.request.target.Target;
import top.shixinzhang.sxframework.imageload.glide.signature.EmptySignature;
 ...
 * @param <DataType> The data type that the resource {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoader} will provide that
 *                  can be decoded by the {@link top.shixinzhang.sxframework.imageload.glide.load.ResourceDecoder}.
...
public class GenericRequestBuilder<ModelType, DataType, ResourceType, TranscodeType> implements Cloneable {
     ...
     *     {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoader}, {@link top.shixinzhang.sxframework.imageload.glide.load.ResourceDecoder}, and
    ...
    /**
     * Sets the {@link top.shixinzhang.sxframework.imageload.glide.load.ResourceDecoder} to use to load the resource from the original data.
     * By default, this decoder will only be used if the final transformed resource is not in the disk cache.
     *
     * @see #cacheDecoder(top.shixinzhang.sxframework.imageload.glide.load.ResourceDecoder)
     * @see top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy
     *
     * @param decoder The {@link top.shixinzhang.sxframework.imageload.glide.load.ResourceDecoder} to use to decode the resource.
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@link top.shixinzhang.sxframework.imageload.glide.load.ResourceDecoder} to use to load the resource from the disk cache. By
     * default, this decoder will only be used if the final transformed resource is already in the disk cache.
     *
     * @see #decoder(top.shixinzhang.sxframework.imageload.glide.load.ResourceDecoder)
     * @see top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy
     *
    ...
    /**
     * Sets the {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy} to use for this load. Defaults to
     * {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy#RESULT}.
     *
     * <p>
     *     For most applications {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy#RESULT} is ideal.
     ...
     *     {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy#SOURCE} or
     *     {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy#RESULT}. Any download only operations should
     *     typically use {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy#SOURCE}.
     * </p>
     *
    ...
    /**
     * Sets the {@link top.shixinzhang.sxframework.imageload.glide.load.Encoder} to use to encode the original data directly to cache. Will only
     * be used if the original data is not already in cache and if the
     * {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy} is set to
     * {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy#SOURCE} or
     * {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy#ALL}.
     *
     * @see #sourceEncoder(top.shixinzhang.sxframework.imageload.glide.load.Encoder)
     * @see top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy
     *
    ...
    /**
     * Removes the current {@link top.shixinzhang.sxframework.imageload.glide.load.Transformation}.
     *
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@link top.shixinzhang.sxframework.imageload.glide.load.resource.transcode.ResourceTranscoder} to use for this load.
     *
     * @see top.shixinzhang.sxframework.imageload.glide.load.resource.transcode.UnitTranscoder
     * @see top.shixinzhang.sxframework.imageload.glide.load.resource.transcode.GlideBitmapDrawableTranscoder
     * @see top.shixinzhang.sxframework.imageload.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder
     *
     ...
     *
     * @see #animate(int)
     * @see #animate(top.shixinzhang.sxframework.imageload.glide.request.animation.ViewPropertyAnimation.Animator)
     *
     ...
     * {@link #animate(top.shixinzhang.sxframework.imageload.glide.request.animation.ViewPropertyAnimation.Animator)}. Scheduled to be removed in
     * Glide 4.0.
     ...
     * memory cache).
     *
     * @param animator The {@link top.shixinzhang.sxframework.imageload.glide.request.animation.ViewPropertyAnimation.Animator} to run.
     * @return This request builder.
     */
     ...
     * impractical to return that size from {@link Target#getSize(top.shixinzhang.sxframework.imageload.glide.request.target.SizeReadyCallback)}.
     *
     ...
     * </p>
     *
     * @see top.shixinzhang.sxframework.imageload.glide.signature.StringSignature
     *
     * @param signature A unique non-null {@link top.shixinzhang.sxframework.imageload.glide.load.Key} representing the current state of the
     ...
     *
     * <p>
     *      This method must be called at least once before {@link #into(top.shixinzhang.sxframework.imageload.glide.request.target.Target)} is
     *      called.
     * </p>
     *
     ...
     *
     * @see Glide#clear(top.shixinzhang.sxframework.imageload.glide.request.target.Target)
     *
     ...
     * @return The {@link top.shixinzhang.sxframework.imageload.glide.request.target.Target} used to wrap the given {@link ImageView}.
     */
     ...
     *              {@link #override * (int, int)}} if previously called).
     *
     * @see Glide#clear(top.shixinzhang.sxframework.imageload.glide.request.FutureTarget)
     *
     * @return An {@link top.shixinzhang.sxframework.imageload.glide.request.FutureTarget} that can be used to obtain the
     ...
     *
     *
     * @see top.shixinzhang.sxframework.imageload.glide.ListPreloader
     *
     * @param width The desired width in pixels, or {@link Target#SIZE_ORIGINAL}. This will be overridden by
     *             {@link #override * (int, int)} if previously called.
     * @param height The desired height in pixels, or {@link Target#SIZE_ORIGINAL}. This will be overridden by
     ...
     *        {@link Glide#clear(top.shixinzhang.sxframework.imageload.glide.request.target.Target)}.
     */
