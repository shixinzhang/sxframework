...
import top.shixinzhang.sxframework.imageload.glide.load.engine.Engine;
import top.shixinzhang.sxframework.imageload.glide.load.engine.bitmap_recycle.BitmapPool;
import top.shixinzhang.sxframework.imageload.glide.load.engine.cache.DiskLruCacheFactory;
import top.shixinzhang.sxframework.imageload.glide.load.engine.cache.MemoryCache;
import top.shixinzhang.sxframework.imageload.glide.load.engine.prefill.BitmapPreFiller;
import top.shixinzhang.sxframework.imageload.glide.load.engine.prefill.PreFillType;
...
import top.shixinzhang.sxframework.imageload.glide.load.model.file_descriptor.FileDescriptorFileLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.file_descriptor.FileDescriptorResourceLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.file_descriptor.FileDescriptorStringLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.file_descriptor.FileDescriptorUriLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.stream.HttpUrlGlideUrlLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamByteArrayLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamFileLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamResourceLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamStringLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamUriLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamUrlLoader;
import top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.CenterCrop;
import top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.FileDescriptorBitmapDataLoadProvider;
import top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.FitCenter;
import top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.GlideBitmapDrawable;
import top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.ImageVideoDataLoadProvider;
import top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.StreamBitmapDataLoadProvider;
import top.shixinzhang.sxframework.imageload.glide.load.resource.drawable.GlideDrawable;
import top.shixinzhang.sxframework.imageload.glide.load.resource.file.StreamFileDataLoadProvider;
import top.shixinzhang.sxframework.imageload.glide.load.resource.gif.GifDrawable;
import top.shixinzhang.sxframework.imageload.glide.load.resource.gif.GifDrawableLoadProvider;
import top.shixinzhang.sxframework.imageload.glide.load.resource.gifbitmap.GifBitmapWrapper;
import top.shixinzhang.sxframework.imageload.glide.load.resource.gifbitmap.GifBitmapWrapperTransformation;
import top.shixinzhang.sxframework.imageload.glide.load.resource.gifbitmap.ImageVideoGifDrawableLoadProvider;
import top.shixinzhang.sxframework.imageload.glide.load.resource.transcode.GifBitmapWrapperDrawableTranscoder;
import top.shixinzhang.sxframework.imageload.glide.load.resource.transcode.GlideBitmapDrawableTranscoder;
import top.shixinzhang.sxframework.imageload.glide.load.resource.transcode.ResourceTranscoder;
import top.shixinzhang.sxframework.imageload.glide.load.resource.transcode.TranscoderRegistry;
import top.shixinzhang.sxframework.imageload.glide.manager.RequestManagerRetriever;
import top.shixinzhang.sxframework.imageload.glide.module.GlideModule;
import top.shixinzhang.sxframework.imageload.glide.module.ManifestParser;
import top.shixinzhang.sxframework.imageload.glide.provider.DataLoadProvider;
import top.shixinzhang.sxframework.imageload.glide.provider.DataLoadProviderRegistry;
...
import top.shixinzhang.sxframework.imageload.glide.request.animation.GlideAnimation;
import top.shixinzhang.sxframework.imageload.glide.request.target.ImageViewTargetFactory;
import top.shixinzhang.sxframework.imageload.glide.request.target.Target;
import top.shixinzhang.sxframework.imageload.glide.request.target.ViewTarget;
 ...
 * maintaining an {@link Engine}, {@link BitmapPool}, {@link top.shixinzhang.sxframework.imageload.glide.load.engine.cache.DiskCache} and
 * {@link MemoryCache}.
 */
public class Glide {
     ...
     *
     * @deprecated Use {@link top.shixinzhang.sxframework.imageload.glide.module.GlideModule} instead. Scheduled to be removed in Glide 4.0.
     */
    @Deprecated
    ...
    /**
     * Returns the {@link top.shixinzhang.sxframework.imageload.glide.load.engine.bitmap_recycle.BitmapPool} used to temporarily store
     ...
     *     {@link top.shixinzhang.sxframework.imageload.glide.load.ResourceDecoder}s and {@link top.shixinzhang.sxframework.imageload.glide.load.Transformation}s. Use
    ...
    /**
     * Pre-fills the {@link top.shixinzhang.sxframework.imageload.glide.load.engine.bitmap_recycle.BitmapPool} using the given sizes.
     *
     * <p>
     ...
     *     re-filling the {@link top.shixinzhang.sxframework.imageload.glide.load.engine.bitmap_recycle.BitmapPool}. Rotation should be carefully
     ...
     *     {@link top.shixinzhang.sxframework.imageload.glide.load.engine.prefill.PreFillType.Builder Builders} representing
     ...
     * models. Typically the {@link RequestManager#using(top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamModelLoader)} or
     * {@link RequestManager#using(top.shixinzhang.sxframework.imageload.glide.load.model.file_descriptor.FileDescriptorModelLoader)} syntax is
     ...
     * </p>
     *
     * @see RequestManager#using(top.shixinzhang.sxframework.imageload.glide.load.model.file_descriptor.FileDescriptorModelLoader)
     * @see RequestManager#using(top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamModelLoader)
     *
     ...
     *
     * @deprecated Use {@link #register(Class, Class, top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoaderFactory)} to replace
