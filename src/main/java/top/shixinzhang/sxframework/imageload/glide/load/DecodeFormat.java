 ...
 * returned by a {@link top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.BitmapDecoder}.
 *
 * <p>
 *     Note - In some cases it may not be possible to obey the requested setting, not all
 *     {@link top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.BitmapDecoder}s support setting formats and certain images may
...
public enum DecodeFormat {
    /**
     * All bitmaps returned by the {@link top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.BitmapDecoder} should return
