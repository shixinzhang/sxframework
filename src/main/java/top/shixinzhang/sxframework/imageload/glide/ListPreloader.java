...
import top.shixinzhang.sxframework.imageload.glide.request.target.BaseTarget;
import top.shixinzhang.sxframework.imageload.glide.request.target.SizeReadyCallback;
...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
    ...
    public interface PreloadModelProvider<U> {
        ...
        /**
         * Returns a non null {@link top.shixinzhang.sxframework.imageload.glide.GenericRequestBuilder} for a given item. Must exactly match
    ...
    /**
     * Constructor for {@link top.shixinzhang.sxframework.imageload.glide.ListPreloader} that requires users to subclass and override
     * the {@link #getItems(int, int)} and {@link #getRequestBuilder(Object)} methods.
     *
     * @deprecated Use {@link #ListPreloader(top.shixinzhang.sxframework.imageload.glide.ListPreloader.PreloadModelProvider,
     * top.shixinzhang.sxframework.imageload.glide.ListPreloader.PreloadSizeProvider, int)} instead. This constructor will be removed in Glide
     * 4.0.
    ...
    /**
     * Constructor for {@link top.shixinzhang.sxframework.imageload.glide.ListPreloader} that accepts interfaces for providing the dimensions of
     ...
     * </p>
     *
     * @deprecated Use {@link top.shixinzhang.sxframework.imageload.glide.ListPreloader.PreloadSizeProvider} instead. This method will be removed
     * in Glide 4.0.
     * @param item A model
     ...
     * </p>
     *
     * @deprecated Use {@link top.shixinzhang.sxframework.imageload.glide.ListPreloader.PreloadModelProvider} instead. This method will be
    ...
    /**
     * Returns a non null {@link top.shixinzhang.sxframework.imageload.glide.GenericRequestBuilder} for a given item. Must exactly match the
