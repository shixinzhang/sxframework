...
/**
 * A view-less {@link Fragment} used to safely store an {@link top.shixinzhang.sxframework.imageload.glide.RequestManager} that
 * can be used to start, stop and manage Glide requests started for targets the fragment or activity this fragment is a
 * child of.
 *
 * @see top.shixinzhang.sxframework.imageload.glide.manager.SupportRequestManagerFragment
...
public class RequestManagerFragment extends Fragment {
    ...
    /**
     * Returns the current {@link top.shixinzhang.sxframework.imageload.glide.RequestManager} or null if none exists.
     */
