...
import top.shixinzhang.sxframework.imageload.glide.load.engine.executor.Prioritized;
import top.shixinzhang.sxframework.imageload.glide.request.ResourceCallback;

/**
 * A runnable class responsible for using an {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DecodeJob} to decode resources on a
 ...
 *     {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DecodeJob} to decode data directly from the original source.
 * </p>
 *
 * <p>
