...
import top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy;
import top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.file_descriptor.FileDescriptorModelLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.stream.MediaStoreStreamLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamByteArrayLoader;
import top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamModelLoader;
import top.shixinzhang.sxframework.imageload.glide.manager.ConnectivityMonitor;
import top.shixinzhang.sxframework.imageload.glide.manager.ConnectivityMonitorFactory;
import top.shixinzhang.sxframework.imageload.glide.manager.Lifecycle;
import top.shixinzhang.sxframework.imageload.glide.manager.LifecycleListener;
import top.shixinzhang.sxframework.imageload.glide.manager.RequestManagerTreeNode;
import top.shixinzhang.sxframework.imageload.glide.manager.RequestTracker;
import top.shixinzhang.sxframework.imageload.glide.signature.ApplicationVersionSignature;
import top.shixinzhang.sxframework.imageload.glide.signature.MediaStoreSignature;
import top.shixinzhang.sxframework.imageload.glide.signature.StringSignature;
...
public class RequestManager implements LifecycleListener {
     ...
     * {@link top.shixinzhang.sxframework.imageload.glide.RequestManager}.
     */
     ...
     * <p>
     * <p>
     * Note - These options will be retained for the life the of this {@link top.shixinzhang.sxframework.imageload.glide.RequestManager}
     * so be wary of using
     * {@link top.shixinzhang.sxframework.imageload.glide.GenericRequestBuilder#listener(top.shixinzhang.sxframework.imageload.glide.request.RequestListener)}} when
    ...
    /**
     * Returns a request builder that uses the given {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoader} to fetch a
     * generic data type.
     * <p>
     * <p>
    ...
    /**
     * Returns a request builder that uses the given {@link top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamModelLoader} to
     ...
     * {@link top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamByteArrayLoader} to fetch an {@link InputStream} for
     * loading Bitmaps.
     *
     ...
     * signature.
     *
     * @param string A file path, or a uri or url handled by {@link top.shixinzhang.sxframework.imageload.glide.load.model.UriLoader}.
     * @see #fromString()
     * @see #load(Object)
     */
     ...
     * {@link top.shixinzhang.sxframework.imageload.glide.GenericRequestBuilder#signature(top.shixinzhang.sxframework.imageload.glide.load.Key)} to mixin a signature
     * you create that identifies the data currently at the given String that will invalidate the cache if that data
     * changes. Alternatively, using {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy#NONE} and/or
     * {@link top.shixinzhang.sxframework.imageload.glide.DrawableRequestBuilder#skipMemoryCache(boolean)} may be appropriate.
     * </p>
     *
     * @see #from(Class)
     * @see #load(String)
     ...
     *            {@link top.shixinzhang.sxframework.imageload.glide.load.model.UriLoader}.
     * @see #fromUri()
     * @see #load(Object)
     */
     ...
     * Alternatively, using {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy#NONE} and/or
     * {@link top.shixinzhang.sxframework.imageload.glide.DrawableRequestBuilder#skipMemoryCache(boolean)} may be appropriate.
     * </p>
     *
     * @see #from(Class)
     ...
     * @see top.shixinzhang.sxframework.imageload.glide.GenericRequestBuilder#signature(top.shixinzhang.sxframework.imageload.glide.load.Key)
     */
     ...
     * @see #load(Uri)
     * @see top.shixinzhang.sxframework.imageload.glide.GenericRequestBuilder#signature(top.shixinzhang.sxframework.imageload.glide.load.Key)
     * @see top.shixinzhang.sxframework.imageload.glide.signature.MediaStoreSignature
     * @deprecated Use {@link #loadFromMediaStore(Uri)},
     * {@link top.shixinzhang.sxframework.imageload.glide.signature.MediaStoreSignature}, and
     * {@link top.shixinzhang.sxframework.imageload.glide.DrawableRequestBuilder#signature(top.shixinzhang.sxframework.imageload.glide.load.Key)} instead. Scheduled to be
     ...
     * <p>
     * <p>
     * Falls back to the registered {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoaderFactory} registered for
     ...
     * {@link top.shixinzhang.sxframework.imageload.glide.GenericRequestBuilder#signature(top.shixinzhang.sxframework.imageload.glide.load.Key)} to mix in some
     * additional data identifying the current state of the Uri, preferably using
     * {@link top.shixinzhang.sxframework.imageload.glide.signature.MediaStoreSignature}. Alternatively consider avoiding the memory and
     * disk caches entirely using
     * {@link GenericRequestBuilder#diskCacheStrategy(top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy)}
     * and {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy#NONE} and/or
     * {@link top.shixinzhang.sxframework.imageload.glide.GenericRequestBuilder#skipMemoryCache(boolean)}.
     * </p>
     *
     * @see #from(Class)
     * @see #loadFromMediaStore(Uri, String, long, int)
    ...
    /**
     * Returns a request builder that uses the {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoaderFactory} currently
     * registered for {@link File} to load the image represented by the given {@link File}. Defaults to
     * {@link top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamFileLoader.Factory} and
     * {@link top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamFileLoader} to load images from {@link File}s.
     * <p>
     * <p>
     ...
     * to {@link top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamResourceLoader.Factory} and
     * {@link top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamResourceLoader} to load resource id models.
     * <p>
     * <p>
     ...
     * cached data. To get around this, consider using {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy#NONE}
     * via {@link GenericRequestBuilder#diskCacheStrategy(top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy)}
     * during development, and re-enabling the default
     * {@link top.shixinzhang.sxframework.imageload.glide.load.engine.DiskCacheStrategy#RESULT} for release builds.
     * </p>
     *
     * @see #from(Class)
     * @see #load(Integer)
     * @see top.shixinzhang.sxframework.imageload.glide.signature.ApplicationVersionSignature
     * @see top.shixinzhang.sxframework.imageload.glide.GenericRequestBuilder#signature(top.shixinzhang.sxframework.imageload.glide.load.Key)
     */
     ...
     * {@link top.shixinzhang.sxframework.imageload.glide.load.model.stream.HttpUrlGlideUrlLoader} and
     * {@link top.shixinzhang.sxframework.imageload.glide.load.data.HttpUrlFetcher} to load {@link URL} models.
     *
     * @see #from(Class)
     * @see #load(URL)
     * @deprecated The {@link URL} class has
     ...
     * {@link top.shixinzhang.sxframework.imageload.glide.GenericRequestBuilder#signature(top.shixinzhang.sxframework.imageload.glide.load.Key)} instead. Scheduled to be
     * removed in Glide 4.0.
     */
    @Deprecated
    ...
    /**
     * Returns a request builder that uses {@link top.shixinzhang.sxframework.imageload.glide.load.model.stream.StreamByteArrayLoader} to load
    ...
    /**
     * Returns a request builder that uses the {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoaderFactory}s currently
     ...
     * {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoaderFactory}s registered for the given model class for
     * {@link InputStream}s and {@link ParcelFileDescriptor}s to load a thumbnail from objects of
     * the given modelClass.
     * <p>
     * <p>
     * Note - you must use {@link top.shixinzhang.sxframework.imageload.glide.DrawableRequestBuilder#load(Object)}} to set a concrete model
     * to be loaded before calling
     * {@link top.shixinzhang.sxframework.imageload.glide.DrawableRequestBuilder#into(top.shixinzhang.sxframework.imageload.glide.request.target.Target)}. You may
     * also use this object for repeated loads by calling <code>request.load(model).into(target)</code>. You may
     * also adjust the options after calling {@link top.shixinzhang.sxframework.imageload.glide.DrawableRequestBuilder#load(Object)}} and/or
     * {@link top.shixinzhang.sxframework.imageload.glide.DrawableRequestBuilder#into(top.shixinzhang.sxframework.imageload.glide.request.target.Target)}}. However,
    ...
    public final class ImageModelRequest<T> {
        ...
        /**
         * Returns a request builder that uses the provided {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoader} to load
     ...
     * @param <T> The type of data the {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoader} provides an
     *            {@link top.shixinzhang.sxframework.imageload.glide.load.data.DataFetcher} to convert the model to.
     */
    public final class GenericModelRequest<A, T> {
        ...
        /**
         * A helper class for building requests with custom {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoader}s that
