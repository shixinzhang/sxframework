...
import top.shixinzhang.sxframework.imageload.glide.load.resource.gif.GifDrawableTransformation;
...
public class GifRequestBuilder<ModelType>
    ...
    /**
     * Transforms each frame of the GIF using {@link top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
     * @see #transformFrame(top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.BitmapTransformation...)
     * @see #transformFrame(top.shixinzhang.sxframework.imageload.glide.load.Transformation[])
    ...
    /**
     * Transforms each frame of the GIF using {@link top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transformFrame(top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.BitmapTransformation...)
     * @see #transformFrame(top.shixinzhang.sxframework.imageload.glide.load.Transformation[])
