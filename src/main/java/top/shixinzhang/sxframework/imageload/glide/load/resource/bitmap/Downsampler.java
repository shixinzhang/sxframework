...
import top.shixinzhang.sxframework.imageload.glide.util.ByteArrayPool;
import top.shixinzhang.sxframework.imageload.glide.util.ExceptionCatchingInputStream;
import top.shixinzhang.sxframework.imageload.glide.util.MarkEnforcingInputStream;
...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    ...
    public static final Downsampler AT_LEAST = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "AT_LEAST.top.shixinzhang.sxframework.imageload.glide.load.data.bitmap";
        }
    };
    ...
    public static final Downsampler AT_MOST = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "AT_MOST.top.shixinzhang.sxframework.imageload.glide.load.data.bitmap";
        }
    };
    ...
    public static final Downsampler NONE = new Downsampler() {
        ...
        @Override
        public String getId() {
            return "NONE.top.shixinzhang.sxframework.imageload.glide.load.data.bitmap";
        }
    };
