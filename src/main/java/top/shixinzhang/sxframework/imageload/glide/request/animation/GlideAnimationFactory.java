...
/**
 * A factory class that can produce different {@link top.shixinzhang.sxframework.imageload.glide.request.animation.GlideAnimation}s based on the
...
public interface GlideAnimationFactory<R> {
    ...
    /**
     * Returns a new {@link top.shixinzhang.sxframework.imageload.glide.request.animation.GlideAnimation}.
     *
