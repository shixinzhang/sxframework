...
import top.shixinzhang.sxframework.imageload.glide.gifdecoder.GifHeader;
...
public class GifDrawable extends GlideDrawable implements GifFrameLoader.FrameCallback {
     ...
     *
     * @see #setFrameTransformation(top.shixinzhang.sxframework.imageload.glide.load.Transformation, Bitmap)
     *
     * @param context A context.
     * @param bitmapProvider An {@link top.shixinzhang.sxframework.imageload.glide.gifdecoder.GifDecoder.BitmapProvider} that can be used to
     *                       retrieve re-usable {@link Bitmap}s.
     * @param bitmapPool A {@link top.shixinzhang.sxframework.imageload.glide.load.engine.bitmap_recycle.BitmapPool} that can be used to return
     *                   the first frame when this drawable is recycled.
     * @param frameTransformation An {@link top.shixinzhang.sxframework.imageload.glide.load.Transformation} that can be applied to each frame.
     * @param targetFrameWidth The desired width of the frames displayed by this drawable (the width of the view or
     *                         {@link top.shixinzhang.sxframework.imageload.glide.request.target.Target} this drawable is being loaded into).
