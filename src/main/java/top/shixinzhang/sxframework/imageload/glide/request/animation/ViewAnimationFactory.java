...
/**
 * A {@link top.shixinzhang.sxframework.imageload.glide.request.animation.GlideAnimationFactory} that produces
 * {@link top.shixinzhang.sxframework.imageload.glide.request.animation.ViewAnimation}s.
 *
...
public class ViewAnimationFactory<R> implements GlideAnimationFactory<R> {
    ...
    /**
     * Returns a new {@link top.shixinzhang.sxframework.imageload.glide.request.animation.GlideAnimation} for the given arguments. If
     * isFromMemoryCache is {@code true} or isFirstImage is {@code false}, returns a
     * {@link top.shixinzhang.sxframework.imageload.glide.request.animation.NoAnimation} and otherwise returns a new
