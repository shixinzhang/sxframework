package top.shixinzhang.sxframework.imageload.glide.request.animation;
 ...
 * {@link top.shixinzhang.sxframework.imageload.glide.request.target.Target}s in across resource types. Targets that wrap views will be able to
...
public interface GlideAnimation<R> {
     ...
     * ({@link top.shixinzhang.sxframework.imageload.glide.request.animation.ViewAnimation},
     * {@link top.shixinzhang.sxframework.imageload.glide.request.animation.ViewPropertyAnimation} and animated
     * {@link Drawable}s).
     */
     ...
     * @param adapter The {@link top.shixinzhang.sxframework.imageload.glide.request.animation.GlideAnimation.ViewAdapter} wrapping a view that
     *                can at least return an {@link View} from
     *                {@link top.shixinzhang.sxframework.imageload.glide.request.animation.GlideAnimation.ViewAdapter#getView()}.
