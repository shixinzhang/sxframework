...
/**
 * An {@link top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.BitmapDecoder} that can decode a thumbnail frame
...
public class VideoBitmapDecoder implements BitmapDecoder<ParcelFileDescriptor> {
    ...
    @Override
    public String getId() {
        return "VideoBitmapDecoder.top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap";
    }
