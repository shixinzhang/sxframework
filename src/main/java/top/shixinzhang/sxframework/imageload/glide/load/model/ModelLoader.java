 ...
 * @param <Y> The type of the data that can be used by a {@link top.shixinzhang.sxframework.imageload.glide.load.ResourceDecoder} to decode a
 *           resource.
 */
public interface ModelLoader<T, Y> {
     ...
     *              {@link top.shixinzhang.sxframework.imageload.glide.request.target.Target#SIZE_ORIGINAL} to indicate that the resource should
     ...
     * cached, or null if no valid {@link top.shixinzhang.sxframework.imageload.glide.load.data.DataFetcher} could be constructed.
     */
