...
import top.shixinzhang.sxframework.imageload.glide.RequestManager;
 ...
 * {@link top.shixinzhang.sxframework.imageload.glide.RequestManager} that can be used to start, stop and manage Glide requests started for
 * targets within the fragment or activity this fragment is a child of.
 *
 * @see top.shixinzhang.sxframework.imageload.glide.manager.RequestManagerFragment
 * @see top.shixinzhang.sxframework.imageload.glide.manager.RequestManagerRetriever
 * @see top.shixinzhang.sxframework.imageload.glide.RequestManager
 */
public class SupportRequestManagerFragment extends Fragment {
    ...
    /**
     * Sets the current {@link top.shixinzhang.sxframework.imageload.glide.RequestManager}.
     *
    ...
    /**
     * Returns the current {@link top.shixinzhang.sxframework.imageload.glide.RequestManager} or null if none is set.
     */
