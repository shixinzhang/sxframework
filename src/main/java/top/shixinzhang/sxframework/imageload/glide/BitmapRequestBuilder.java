...
import top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.BitmapTransformation;
import top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.Downsampler;
import top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.FileDescriptorBitmapDecoder;
import top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.ImageVideoBitmapDecoder;
import top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.StreamBitmapDecoder;
import top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.VideoBitmapDecoder;
...
public class BitmapRequestBuilder<ModelType, TranscodeType>
     ...
     * {@link top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.Downsampler#AT_MOST}.
     *
     * @see #downsample(top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.Downsampler)
     *
     * @return This request builder.
     */
    ...
    /**
     * Sets the {@link top.shixinzhang.sxframework.imageload.glide.load.ResourceDecoder} that will be used to decode {@link Bitmap}s obtained
     ...
     * {@link #cacheDecoder(top.shixinzhang.sxframework.imageload.glide.load.ResourceDecoder)}} with default decoders with the appropriate
     * options set.
     *
     * <p>
    ...
    /**
     * Transform images using the given {@link top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.BitmapTransformation}s.
     *
     * @see #centerCrop()
     * @see #fitCenter()
     * @see #transform(top.shixinzhang.sxframework.imageload.glide.load.Transformation[])
     *
    ...
    /**
     * Transform images using {@link top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.CenterCrop}.
     *
     * @see #fitCenter()
     * @see #transform(top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.BitmapTransformation...)
     * @see #transform(top.shixinzhang.sxframework.imageload.glide.load.Transformation[])
     *
     * @return This request builder.
     */
    ...
    /**
     * Transform images using {@link top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.FitCenter}.
     *
     * @see #centerCrop()
     * @see #transform(top.shixinzhang.sxframework.imageload.glide.load.resource.bitmap.BitmapTransformation...)
     * @see #transform(top.shixinzhang.sxframework.imageload.glide.load.Transformation[])
