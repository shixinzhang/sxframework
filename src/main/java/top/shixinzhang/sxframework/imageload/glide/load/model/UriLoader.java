 ...
 * remote {@link Uri}s to a wrapped {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoader} that handles
 * {@link top.shixinzhang.sxframework.imageload.glide.load.model.GlideUrl}s.
 *
