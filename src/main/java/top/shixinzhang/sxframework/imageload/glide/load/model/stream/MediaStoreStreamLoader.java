...
import top.shixinzhang.sxframework.imageload.glide.load.data.MediaStoreThumbFetcher;
import top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoader;

import java.io.InputStream;

/**
 * An {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoader} that can use media store uris to open pre-generated thumbnails
 ...
 * it falls back to the wrapped {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoader} to load the
