 ...
 * resource load by {@link top.shixinzhang.sxframework.imageload.glide.load.model.ModelLoader}. {@link #loadData(Priority)} may or may not be
...
public interface DataFetcher<T> {
     ...
     * {@link top.shixinzhang.sxframework.imageload.glide.load.ResourceDecoder}.
     *
     * <p>
     *     Note - this method will be run on a background thread so blocking I/O is safe.
     * </p>
