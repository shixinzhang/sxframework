package top.shixinzhang.sxframework.imageload.glide.signature;
...
/**
 * A utility class for obtaining a {@link top.shixinzhang.sxframework.imageload.glide.load.Key} signature containing the application version
...
public final class ApplicationVersionSignature {
    ...
    /**
     * Returns the signature {@link top.shixinzhang.sxframework.imageload.glide.load.Key} for version code of the Application of the given
     * Context.
     */
