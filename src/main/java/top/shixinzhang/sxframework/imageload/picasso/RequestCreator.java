...
import static top.shixinzhang.sxframework.imageload.picasso.BitmapHunter.forRequest;
import static top.shixinzhang.sxframework.imageload.picasso.MemoryPolicy.NO_CACHE;
import static top.shixinzhang.sxframework.imageload.picasso.MemoryPolicy.NO_STORE;
import static top.shixinzhang.sxframework.imageload.picasso.MemoryPolicy.shouldReadFromMemoryCache;
import static top.shixinzhang.sxframework.imageload.picasso.Picasso.LoadedFrom.MEMORY;
import static top.shixinzhang.sxframework.imageload.picasso.Picasso.Priority;
import static top.shixinzhang.sxframework.imageload.picasso.PicassoDrawable.setBitmap;
import static top.shixinzhang.sxframework.imageload.picasso.PicassoDrawable.setPlaceholder;
import static top.shixinzhang.sxframework.imageload.picasso.RemoteViewsAction.AppWidgetAction;
import static top.shixinzhang.sxframework.imageload.picasso.RemoteViewsAction.NotificationAction;
import static top.shixinzhang.sxframework.imageload.picasso.Utils.OWNER_MAIN;
import static top.shixinzhang.sxframework.imageload.picasso.Utils.VERB_CHANGED;
import static top.shixinzhang.sxframework.imageload.picasso.Utils.VERB_COMPLETED;
import static top.shixinzhang.sxframework.imageload.picasso.Utils.VERB_CREATED;
import static top.shixinzhang.sxframework.imageload.picasso.Utils.checkMain;
import static top.shixinzhang.sxframework.imageload.picasso.Utils.checkNotMain;
import static top.shixinzhang.sxframework.imageload.picasso.Utils.createKey;
import static top.shixinzhang.sxframework.imageload.picasso.Utils.log;
...
public class RequestCreator {
    ...
    RequestCreator(@NonNull Picasso picasso, Uri uri, int resourceId) {
        if (picasso.shutdown) {
     ...
     */
    @NonNull
    public RequestCreator error(@Nullable Drawable errorDrawable) {
        if (errorDrawable == null) {
     ...
     */
    @NonNull
    public RequestCreator tag(@Nullable Object tag) {
        if (tag == null) {
     ...
     */
    @NonNull
    public RequestCreator memoryPolicy(@Nullable MemoryPolicy policy, @Nullable MemoryPolicy... additional) {
        if (policy == null) {
     ...
     */
    @NonNull
    public RequestCreator networkPolicy(@Nullable NetworkPolicy policy, @Nullable NetworkPolicy... additional) {
        if (policy == null) {
     ...
     */
    public void into(@Nullable Target target) {
        long started = System.nanoTime();
        checkMain();
     ...
     */
    public void into(@Nullable RemoteViews remoteViews, int viewId, int notificationId,
     ...
     */
    public void into(@Nullable RemoteViews remoteViews, int viewId, @Nullable int[] appWidgetIds) {
        long started = System.nanoTime();
     ...
     */
    public void into(@Nullable ImageView target, @Nullable Callback callback) {
        long started = System.nanoTime();
        checkMain();
    ...
    private void performRemoteViewInto(@NonNull RemoteViewsAction action) {
        if (shouldReadFromMemoryCache(memoryPolicy)) {
