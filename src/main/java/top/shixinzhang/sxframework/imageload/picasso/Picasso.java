...
import static top.shixinzhang.sxframework.imageload.picasso.Dispatcher.*;
...
import static top.shixinzhang.sxframework.imageload.picasso.Utils.THREAD_LEAK_CLEANING_MS;
import static top.shixinzhang.sxframework.imageload.picasso.Utils.THREAD_PREFIX;
...
import static top.shixinzhang.sxframework.imageload.picasso.Utils.VERB_ERRORED;
import static top.shixinzhang.sxframework.imageload.picasso.Utils.VERB_RESUMED;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case REQUEST_GCED: {
                    ...
                    if (action == null) {
                        Log.d("Picasso", "target action is null!! Can't got garbage collected");
                        break;
                    }
