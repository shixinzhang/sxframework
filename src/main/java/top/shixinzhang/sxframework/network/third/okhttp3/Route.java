...
public final class Route {
    final top.shixinzhang.sxframework.network.third.okhttp3.Address address;
    final Proxy proxy;
    final InetSocketAddress inetSocketAddress;

    public Route(top.shixinzhang.sxframework.network.third.okhttp3.Address address, Proxy proxy, InetSocketAddress inetSocketAddress) {
        if (address == null) {
    ...
    public top.shixinzhang.sxframework.network.third.okhttp3.Address address() {
        return address;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof top.shixinzhang.sxframework.network.third.okhttp3.Route) {
            top.shixinzhang.sxframework.network.third.okhttp3.Route other = (top.shixinzhang.sxframework.network.third.okhttp3.Route) obj;
