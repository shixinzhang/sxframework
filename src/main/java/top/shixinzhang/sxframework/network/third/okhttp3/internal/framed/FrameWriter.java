...
public interface FrameWriter extends Closeable {
   ...
   * and (@code :path}.
   */
  void pushPromise(int streamId, int promisedStreamId, List<top.shixinzhang.sxframework.network.third.okhttp3.internal.framed.Header> requestHeaders)
      throws IOException;
  ...
  void synStream(boolean outFinished, boolean inFinished, int streamId, int associatedStreamId,
                 List<top.shixinzhang.sxframework.network.third.okhttp3.internal.framed.Header> headerBlock) throws IOException;

  void synReply(boolean outFinished, int streamId, List<top.shixinzhang.sxframework.network.third.okhttp3.internal.framed.Header> headerBlock)
      throws IOException;
