...
public final class Headers {
    ...
    public boolean equals(Object other) {
        return other instanceof top.shixinzhang.sxframework.network.third.okhttp3.Headers
                && Arrays.equals(((top.shixinzhang.sxframework.network.third.okhttp3.Headers) other).namesAndValues, namesAndValues);
    }
     ...
     */
    public static top.shixinzhang.sxframework.network.third.okhttp3.Headers of(String... namesAndValues) {
        ...
        return new top.shixinzhang.sxframework.network.third.okhttp3.Headers(namesAndValues);
    }

    /**
     * Returns headers for the header names and values in the {@link Map}.
     */
    public static top.shixinzhang.sxframework.network.third.okhttp3.Headers of(Map<String, String> headers) {
    ...
    public static final class Builder {
        ...
        public top.shixinzhang.sxframework.network.third.okhttp3.Headers build() {
            return new top.shixinzhang.sxframework.network.third.okhttp3.Headers(this);
        }
    }
}
