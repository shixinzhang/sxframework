...
import static top.shixinzhang.sxframework.network.third.okhttp3.internal.http.StatusLine.HTTP_PERM_REDIRECT;
...
public final class Response implements Closeable {
    ...
    private final top.shixinzhang.sxframework.network.third.okhttp3.Response networkResponse;
    private final top.shixinzhang.sxframework.network.third.okhttp3.Response cacheResponse;
    private final top.shixinzhang.sxframework.network.third.okhttp3.Response priorResponse;
     ...
     * should not be read.
     */
    public top.shixinzhang.sxframework.network.third.okhttp3.Response networkResponse() {
     ...
     */
    public top.shixinzhang.sxframework.network.third.okhttp3.Response cacheResponse() {
     ...
     * client.
     */
    public top.shixinzhang.sxframework.network.third.okhttp3.Response priorResponse() {
    ...
    public static class Builder {
        ...
        private top.shixinzhang.sxframework.network.third.okhttp3.Response networkResponse;
        private top.shixinzhang.sxframework.network.third.okhttp3.Response cacheResponse;
        private top.shixinzhang.sxframework.network.third.okhttp3.Response priorResponse;
        ...
        private Builder(top.shixinzhang.sxframework.network.third.okhttp3.Response response) {
        ...
        public Builder networkResponse(top.shixinzhang.sxframework.network.third.okhttp3.Response networkResponse) {
            if (networkResponse != null) checkSupportResponse("networkResponse", networkResponse);
            this.networkResponse = networkResponse;
            return this;
        }

        public Builder cacheResponse(top.shixinzhang.sxframework.network.third.okhttp3.Response cacheResponse) {
            if (cacheResponse != null) checkSupportResponse("cacheResponse", cacheResponse);
            this.cacheResponse = cacheResponse;
            return this;
        }

        private void checkSupportResponse(String name, top.shixinzhang.sxframework.network.third.okhttp3.Response response) {
        ...
        public Builder priorResponse(top.shixinzhang.sxframework.network.third.okhttp3.Response priorResponse) {
            if (priorResponse != null) checkPriorResponse(priorResponse);
            this.priorResponse = priorResponse;
            return this;
        }

        private void checkPriorResponse(top.shixinzhang.sxframework.network.third.okhttp3.Response response) {
            if (response.body != null) {
        ...
        public top.shixinzhang.sxframework.network.third.okhttp3.Response build() {
            if (request == null) throw new IllegalStateException("request == null");
            if (protocol == null) throw new IllegalStateException("protocol == null");
            if (code < 0) throw new IllegalStateException("code < 0: " + code);
            return new top.shixinzhang.sxframework.network.third.okhttp3.Response(this);
        }
    }
}
