...
import static top.shixinzhang.sxframework.network.third.okhttp3.internal.Util.equal;
...
public final class Address {
    ...
    public boolean equals(Object other) {
        if (other instanceof top.shixinzhang.sxframework.network.third.okhttp3.Address) {
            top.shixinzhang.sxframework.network.third.okhttp3.Address that = (top.shixinzhang.sxframework.network.third.okhttp3.Address) other;
