...
import top.shixinzhang.sxframework.network.third.okhttp3.internal.tls.CertificateChainCleaner;
 ...
 * <p>
 * <p>{@link top.shixinzhang.sxframework.network.third.okhttp3.CertificatePinner} can not be used to pin self-signed certificate if such certificate
...
public final class CertificatePinner {
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CertificatePinner DEFAULT = new Builder().build();
     ...
     */
    top.shixinzhang.sxframework.network.third.okhttp3.CertificatePinner withCertificateChainCleaner(CertificateChainCleaner certificateChainCleaner) {
        return this.certificateChainCleaner != certificateChainCleaner
                ? new top.shixinzhang.sxframework.network.third.okhttp3.CertificatePinner(pins, certificateChainCleaner)
                : this;
    }
    ...
    static final class Pin {
        ...
        Pin(String pattern, String pin) {
            ...
            this.canonicalHostname = pattern.startsWith(WILDCARD)
                    ? top.shixinzhang.sxframework.network.third.okhttp3.HttpUrl.parse("http://" + pattern.substring(WILDCARD.length())).host()
    ...
    public static final class Builder {
        ...
        public top.shixinzhang.sxframework.network.third.okhttp3.CertificatePinner build() {
            return new top.shixinzhang.sxframework.network.third.okhttp3.CertificatePinner(Util.immutableList(pins), null);
        }
    }
}
