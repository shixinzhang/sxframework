...
public final class Spdy3 implements Variant {
    ...
    static final class Reader implements FrameReader {
        ...
        private final top.shixinzhang.sxframework.network.third.okhttp3.internal.framed.NameValueBlockReader headerBlockReader;

        Reader(BufferedSource source, boolean client) {
            this.source = source;
            this.headerBlockReader = new top.shixinzhang.sxframework.network.third.okhttp3.internal.framed.NameValueBlockReader(this.source);
            this.client = client;
        }
