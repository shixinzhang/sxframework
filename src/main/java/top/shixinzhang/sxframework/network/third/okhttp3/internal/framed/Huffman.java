...
class Huffman {
  ...
  private static final top.shixinzhang.sxframework.network.third.okhttp3.internal.framed.Huffman INSTANCE = new top.shixinzhang.sxframework.network.third.okhttp3.internal.framed.Huffman();

  public static top.shixinzhang.sxframework.network.third.okhttp3.internal.framed.Huffman get() {
    return INSTANCE;
  }
