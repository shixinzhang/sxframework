...
class NameValueBlockReader {
    ...
    public List<top.shixinzhang.sxframework.network.third.okhttp3.internal.framed.Header> readNameValueBlock(int length) throws IOException {
        ...
        List<top.shixinzhang.sxframework.network.third.okhttp3.internal.framed.Header> entries = new ArrayList<>(numberOfPairs);
