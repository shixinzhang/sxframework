...
abstract class ParameterHandler<T> {
    ...
    static final class RelativeUrl extends ParameterHandler<Object> {
        @Override
        void apply(@NonNull RequestBuilder builder, Object value) {
    ...
    static final class Header<T> extends ParameterHandler<T> {
        ...
        @Override
        void apply(@NonNull RequestBuilder builder, @Nullable T value) throws IOException {
    ...
    static final class QueryMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        @Override
        void apply(@NonNull RequestBuilder builder, @Nullable Map<String, T> value) throws IOException {
            if (value == null) {
    ...
    static final class Part<T> extends ParameterHandler<T> {
        ...
        @Override
        void apply(@NonNull RequestBuilder builder, @Nullable T value) {
            if (value == null) return; // Skip null values.
    ...
    static final class RawPart extends ParameterHandler<MultipartBody.Part> {
        ...
        @Override
        void apply(@NonNull RequestBuilder builder, @Nullable MultipartBody.Part value) throws IOException {
