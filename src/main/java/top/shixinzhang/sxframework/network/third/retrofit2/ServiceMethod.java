...
final class ServiceMethod<R, T> {
  ...
  static final class Builder<T, R> {
    ...
    private void parseMethodAnnotation(Annotation annotation) {
      ...
      } else if (annotation instanceof top.shixinzhang.sxframework.network.third.retrofit2.http.Headers) {
        String[] headersToParse = ((top.shixinzhang.sxframework.network.third.retrofit2.http.Headers) annotation).value();
