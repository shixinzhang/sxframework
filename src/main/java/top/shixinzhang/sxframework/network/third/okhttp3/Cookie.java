...
import top.shixinzhang.sxframework.network.third.okhttp3.internal.http.HttpDate;

import static top.shixinzhang.sxframework.network.third.okhttp3.internal.Util.UTC;
import static top.shixinzhang.sxframework.network.third.okhttp3.internal.Util.delimiterOffset;
import static top.shixinzhang.sxframework.network.third.okhttp3.internal.Util.domainToAscii;
import static top.shixinzhang.sxframework.network.third.okhttp3.internal.Util.trimSubstring;
import static top.shixinzhang.sxframework.network.third.okhttp3.internal.Util.verifyAsIpAddress;
...
public final class Cookie {
     ...
     */
    public static top.shixinzhang.sxframework.network.third.okhttp3.Cookie parse(HttpUrl url, String setCookie) {
        return parse(System.currentTimeMillis(), url, setCookie);
    }

    static top.shixinzhang.sxframework.network.third.okhttp3.Cookie parse(long currentTimeMillis, HttpUrl url, String setCookie) {
        int pos = 0;
        ...
        return new top.shixinzhang.sxframework.network.third.okhttp3.Cookie(cookieName, cookieValue, expiresAt, domain, path, secureOnly, httpOnly,
                hostOnly, persistent);
    }
     ...
     */
    public static List<top.shixinzhang.sxframework.network.third.okhttp3.Cookie> parseAll(HttpUrl url, Headers headers) {
        List<String> cookieStrings = headers.values("Set-Cookie");
        List<top.shixinzhang.sxframework.network.third.okhttp3.Cookie> cookies = null;

        for (int i = 0, size = cookieStrings.size(); i < size; i++) {
            top.shixinzhang.sxframework.network.third.okhttp3.Cookie cookie = top.shixinzhang.sxframework.network.third.okhttp3.Cookie.parse(url, cookieStrings.get(i));
        ...
        return cookies != null
                ...
                : Collections.<top.shixinzhang.sxframework.network.third.okhttp3.Cookie>emptyList();
    }
    ...
    public static final class Builder {
        ...
        public top.shixinzhang.sxframework.network.third.okhttp3.Cookie build() {
            return new top.shixinzhang.sxframework.network.third.okhttp3.Cookie(this);
        }
    }
    ...
    public boolean equals(Object other) {
        if (!(other instanceof top.shixinzhang.sxframework.network.third.okhttp3.Cookie))
            return false;
        top.shixinzhang.sxframework.network.third.okhttp3.Cookie that = (top.shixinzhang.sxframework.network.third.okhttp3.Cookie) other;
