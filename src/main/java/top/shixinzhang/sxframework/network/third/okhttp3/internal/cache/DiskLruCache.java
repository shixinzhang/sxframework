...
import top.shixinzhang.sxframework.network.third.okhttp3.internal.io.FileSystem;
...
public final class DiskLruCache implements Closeable, Flushable {
  ...
  private final Runnable cleanupRunnable = new Runnable() {
    public void run() {
      synchronized (top.shixinzhang.sxframework.network.third.okhttp3.internal.cache.DiskLruCache.this) {
   ...
   */
  public static top.shixinzhang.sxframework.network.third.okhttp3.internal.cache.DiskLruCache create(FileSystem fileSystem, File directory, int appVersion,
    ...
    return new top.shixinzhang.sxframework.network.third.okhttp3.internal.cache.DiskLruCache(fileSystem, directory, appVersion, valueCount, maxSize, executor);
  }
  ...
  private BufferedSink newJournalWriter() throws FileNotFoundException {
    ...
    Sink faultHidingSink = new FaultHidingSink(fileSink) {
      @Override protected void onException(IOException e) {
        assert (Thread.holdsLock(top.shixinzhang.sxframework.network.third.okhttp3.internal.cache.DiskLruCache.this));
  ...
  public synchronized Iterator<Snapshot> snapshots() throws IOException {
    ...
    return new Iterator<Snapshot>() {
      ...
      @Override public void remove() {
        ...
        try {
          top.shixinzhang.sxframework.network.third.okhttp3.internal.cache.DiskLruCache.this.remove(removeSnapshot.key);
        } catch (IOException ignored) {
  ...
  public final class Snapshot implements Closeable {
    ...
    public Editor edit() throws IOException {
      return top.shixinzhang.sxframework.network.third.okhttp3.internal.cache.DiskLruCache.this.edit(key, sequenceNumber);
    }
  ...
  private final class Entry {
     ...
     */
    Snapshot snapshot() {
      if (!Thread.holdsLock(top.shixinzhang.sxframework.network.third.okhttp3.internal.cache.DiskLruCache.this)) throw new AssertionError();
