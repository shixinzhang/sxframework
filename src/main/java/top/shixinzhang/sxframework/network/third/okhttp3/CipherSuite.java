...
public final class CipherSuite {
     ...
     */
    private static final ConcurrentMap<String, top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite> INSTANCES = new ConcurrentHashMap<>();
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_WITH_NULL_MD5 = of("SSL_RSA_WITH_NULL_MD5", 0x0001, 5246, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_WITH_NULL_SHA = of("SSL_RSA_WITH_NULL_SHA", 0x0002, 5246, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_EXPORT_WITH_RC4_40_MD5 = of("SSL_RSA_EXPORT_WITH_RC4_40_MD5", 0x0003, 4346, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_WITH_RC4_128_MD5 = of("SSL_RSA_WITH_RC4_128_MD5", 0x0004, 5246, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_WITH_RC4_128_SHA = of("SSL_RSA_WITH_RC4_128_SHA", 0x0005, 5246, 6, 10);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_EXPORT_WITH_DES40_CBC_SHA = of("SSL_RSA_EXPORT_WITH_DES40_CBC_SHA", 0x0008, 4346, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_WITH_DES_CBC_SHA = of("SSL_RSA_WITH_DES_CBC_SHA", 0x0009, 5469, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_WITH_3DES_EDE_CBC_SHA = of("SSL_RSA_WITH_3DES_EDE_CBC_SHA", 0x000a, 5246, 6, 10);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_DSS_EXPORT_WITH_DES40_CBC_SHA = of("SSL_DHE_DSS_EXPORT_WITH_DES40_CBC_SHA", 0x0011, 4346, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_DSS_WITH_DES_CBC_SHA = of("SSL_DHE_DSS_WITH_DES_CBC_SHA", 0x0012, 5469, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_DSS_WITH_3DES_EDE_CBC_SHA = of("SSL_DHE_DSS_WITH_3DES_EDE_CBC_SHA", 0x0013, 5246, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_RSA_EXPORT_WITH_DES40_CBC_SHA = of("SSL_DHE_RSA_EXPORT_WITH_DES40_CBC_SHA", 0x0014, 4346, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_RSA_WITH_DES_CBC_SHA = of("SSL_DHE_RSA_WITH_DES_CBC_SHA", 0x0015, 5469, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA = of("SSL_DHE_RSA_WITH_3DES_EDE_CBC_SHA", 0x0016, 5246, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DH_anon_EXPORT_WITH_RC4_40_MD5 = of("SSL_DH_anon_EXPORT_WITH_RC4_40_MD5", 0x0017, 4346, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DH_anon_WITH_RC4_128_MD5 = of("SSL_DH_anon_WITH_RC4_128_MD5", 0x0018, 5246, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DH_anon_EXPORT_WITH_DES40_CBC_SHA = of("SSL_DH_anon_EXPORT_WITH_DES40_CBC_SHA", 0x0019, 4346, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DH_anon_WITH_DES_CBC_SHA = of("SSL_DH_anon_WITH_DES_CBC_SHA", 0x001a, 5469, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DH_anon_WITH_3DES_EDE_CBC_SHA = of("SSL_DH_anon_WITH_3DES_EDE_CBC_SHA", 0x001b, 5246, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_KRB5_WITH_DES_CBC_SHA = of("TLS_KRB5_WITH_DES_CBC_SHA", 0x001e, 2712, 6, MAX_VALUE);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_KRB5_WITH_3DES_EDE_CBC_SHA = of("TLS_KRB5_WITH_3DES_EDE_CBC_SHA", 0x001f, 2712, 6, MAX_VALUE);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_KRB5_WITH_RC4_128_SHA = of("TLS_KRB5_WITH_RC4_128_SHA", 0x0020, 2712, 6, MAX_VALUE);
    // public static final CipherSuite TLS_KRB5_WITH_IDEA_CBC_SHA = of("TLS_KRB5_WITH_IDEA_CBC_SHA", 0x0021, 2712, MAX_VALUE, MAX_VALUE);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_KRB5_WITH_DES_CBC_MD5 = of("TLS_KRB5_WITH_DES_CBC_MD5", 0x0022, 2712, 6, MAX_VALUE);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_KRB5_WITH_3DES_EDE_CBC_MD5 = of("TLS_KRB5_WITH_3DES_EDE_CBC_MD5", 0x0023, 2712, 6, MAX_VALUE);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_KRB5_WITH_RC4_128_MD5 = of("TLS_KRB5_WITH_RC4_128_MD5", 0x0024, 2712, 6, MAX_VALUE);
    // public static final CipherSuite TLS_KRB5_WITH_IDEA_CBC_MD5 = of("TLS_KRB5_WITH_IDEA_CBC_MD5", 0x0025, 2712, MAX_VALUE, MAX_VALUE);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_KRB5_EXPORT_WITH_DES_CBC_40_SHA = of("TLS_KRB5_EXPORT_WITH_DES_CBC_40_SHA", 0x0026, 2712, 6, MAX_VALUE);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_KRB5_EXPORT_WITH_RC4_40_SHA = of("TLS_KRB5_EXPORT_WITH_RC4_40_SHA", 0x0028, 2712, 6, MAX_VALUE);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_KRB5_EXPORT_WITH_DES_CBC_40_MD5 = of("TLS_KRB5_EXPORT_WITH_DES_CBC_40_MD5", 0x0029, 2712, 6, MAX_VALUE);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_KRB5_EXPORT_WITH_RC4_40_MD5 = of("TLS_KRB5_EXPORT_WITH_RC4_40_MD5", 0x002b, 2712, 6, MAX_VALUE);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_WITH_AES_128_CBC_SHA = of("TLS_RSA_WITH_AES_128_CBC_SHA", 0x002f, 5246, 6, 10);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_DSS_WITH_AES_128_CBC_SHA = of("TLS_DHE_DSS_WITH_AES_128_CBC_SHA", 0x0032, 5246, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_RSA_WITH_AES_128_CBC_SHA = of("TLS_DHE_RSA_WITH_AES_128_CBC_SHA", 0x0033, 5246, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DH_anon_WITH_AES_128_CBC_SHA = of("TLS_DH_anon_WITH_AES_128_CBC_SHA", 0x0034, 5246, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_WITH_AES_256_CBC_SHA = of("TLS_RSA_WITH_AES_256_CBC_SHA", 0x0035, 5246, 6, 10);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_DSS_WITH_AES_256_CBC_SHA = of("TLS_DHE_DSS_WITH_AES_256_CBC_SHA", 0x0038, 5246, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_RSA_WITH_AES_256_CBC_SHA = of("TLS_DHE_RSA_WITH_AES_256_CBC_SHA", 0x0039, 5246, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DH_anon_WITH_AES_256_CBC_SHA = of("TLS_DH_anon_WITH_AES_256_CBC_SHA", 0x003a, 5246, 6, 10);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_WITH_NULL_SHA256 = of("TLS_RSA_WITH_NULL_SHA256", 0x003b, 5246, 7, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_WITH_AES_128_CBC_SHA256 = of("TLS_RSA_WITH_AES_128_CBC_SHA256", 0x003c, 5246, 7, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_WITH_AES_256_CBC_SHA256 = of("TLS_RSA_WITH_AES_256_CBC_SHA256", 0x003d, 5246, 7, 21);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_DSS_WITH_AES_128_CBC_SHA256 = of("TLS_DHE_DSS_WITH_AES_128_CBC_SHA256", 0x0040, 5246, 7, 21);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 = of("TLS_DHE_RSA_WITH_AES_128_CBC_SHA256", 0x0067, 5246, 7, 21);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_DSS_WITH_AES_256_CBC_SHA256 = of("TLS_DHE_DSS_WITH_AES_256_CBC_SHA256", 0x006a, 5246, 7, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 = of("TLS_DHE_RSA_WITH_AES_256_CBC_SHA256", 0x006b, 5246, 7, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DH_anon_WITH_AES_128_CBC_SHA256 = of("TLS_DH_anon_WITH_AES_128_CBC_SHA256", 0x006c, 5246, 7, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DH_anon_WITH_AES_256_CBC_SHA256 = of("TLS_DH_anon_WITH_AES_256_CBC_SHA256", 0x006d, 5246, 7, 21);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_WITH_AES_128_GCM_SHA256 = of("TLS_RSA_WITH_AES_128_GCM_SHA256", 0x009c, 5288, 8, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_RSA_WITH_AES_256_GCM_SHA384 = of("TLS_RSA_WITH_AES_256_GCM_SHA384", 0x009d, 5288, 8, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_RSA_WITH_AES_128_GCM_SHA256 = of("TLS_DHE_RSA_WITH_AES_128_GCM_SHA256", 0x009e, 5288, 8, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_RSA_WITH_AES_256_GCM_SHA384 = of("TLS_DHE_RSA_WITH_AES_256_GCM_SHA384", 0x009f, 5288, 8, 21);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_DSS_WITH_AES_128_GCM_SHA256 = of("TLS_DHE_DSS_WITH_AES_128_GCM_SHA256", 0x00a2, 5288, 8, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DHE_DSS_WITH_AES_256_GCM_SHA384 = of("TLS_DHE_DSS_WITH_AES_256_GCM_SHA384", 0x00a3, 5288, 8, 21);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DH_anon_WITH_AES_128_GCM_SHA256 = of("TLS_DH_anon_WITH_AES_128_GCM_SHA256", 0x00a6, 5288, 8, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_DH_anon_WITH_AES_256_GCM_SHA384 = of("TLS_DH_anon_WITH_AES_256_GCM_SHA384", 0x00a7, 5288, 8, 21);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_EMPTY_RENEGOTIATION_INFO_SCSV = of("TLS_EMPTY_RENEGOTIATION_INFO_SCSV", 0x00ff, 5746, 6, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_ECDSA_WITH_NULL_SHA = of("TLS_ECDH_ECDSA_WITH_NULL_SHA", 0xc001, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_ECDSA_WITH_RC4_128_SHA = of("TLS_ECDH_ECDSA_WITH_RC4_128_SHA", 0xc002, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA = of("TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA", 0xc003, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA = of("TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA", 0xc004, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA = of("TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA", 0xc005, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_ECDSA_WITH_NULL_SHA = of("TLS_ECDHE_ECDSA_WITH_NULL_SHA", 0xc006, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_ECDSA_WITH_RC4_128_SHA = of("TLS_ECDHE_ECDSA_WITH_RC4_128_SHA", 0xc007, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA = of("TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA", 0xc008, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA = of("TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA", 0xc009, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA = of("TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA", 0xc00a, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_RSA_WITH_NULL_SHA = of("TLS_ECDH_RSA_WITH_NULL_SHA", 0xc00b, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_RSA_WITH_RC4_128_SHA = of("TLS_ECDH_RSA_WITH_RC4_128_SHA", 0xc00c, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_RSA_WITH_3DES_EDE_CBC_SHA = of("TLS_ECDH_RSA_WITH_3DES_EDE_CBC_SHA", 0xc00d, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_RSA_WITH_AES_128_CBC_SHA = of("TLS_ECDH_RSA_WITH_AES_128_CBC_SHA", 0xc00e, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_RSA_WITH_AES_256_CBC_SHA = of("TLS_ECDH_RSA_WITH_AES_256_CBC_SHA", 0xc00f, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_RSA_WITH_NULL_SHA = of("TLS_ECDHE_RSA_WITH_NULL_SHA", 0xc010, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_RSA_WITH_RC4_128_SHA = of("TLS_ECDHE_RSA_WITH_RC4_128_SHA", 0xc011, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA = of("TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA", 0xc012, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA = of("TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA", 0xc013, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA = of("TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA", 0xc014, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_anon_WITH_NULL_SHA = of("TLS_ECDH_anon_WITH_NULL_SHA", 0xc015, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_anon_WITH_RC4_128_SHA = of("TLS_ECDH_anon_WITH_RC4_128_SHA", 0xc016, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_anon_WITH_3DES_EDE_CBC_SHA = of("TLS_ECDH_anon_WITH_3DES_EDE_CBC_SHA", 0xc017, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_anon_WITH_AES_128_CBC_SHA = of("TLS_ECDH_anon_WITH_AES_128_CBC_SHA", 0xc018, 4492, 7, 14);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_anon_WITH_AES_256_CBC_SHA = of("TLS_ECDH_anon_WITH_AES_256_CBC_SHA", 0xc019, 4492, 7, 14);
    ...
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256 = of("TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256", 0xc023, 5289, 7, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384 = of("TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384", 0xc024, 5289, 7, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256 = of("TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256", 0xc025, 5289, 7, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384 = of("TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384", 0xc026, 5289, 7, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256 = of("TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256", 0xc027, 5289, 7, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384 = of("TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384", 0xc028, 5289, 7, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256 = of("TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256", 0xc029, 5289, 7, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_RSA_WITH_AES_256_CBC_SHA384 = of("TLS_ECDH_RSA_WITH_AES_256_CBC_SHA384", 0xc02a, 5289, 7, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256 = of("TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256", 0xc02b, 5289, 8, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384 = of("TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384", 0xc02c, 5289, 8, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256 = of("TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256", 0xc02d, 5289, 8, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_ECDSA_WITH_AES_256_GCM_SHA384 = of("TLS_ECDH_ECDSA_WITH_AES_256_GCM_SHA384", 0xc02e, 5289, 8, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256 = of("TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256", 0xc02f, 5289, 8, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 = of("TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384", 0xc030, 5289, 8, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256 = of("TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256", 0xc031, 5289, 8, 21);
    public static final top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite TLS_ECDH_RSA_WITH_AES_256_GCM_SHA384 = of("TLS_ECDH_RSA_WITH_AES_256_GCM_SHA384", 0xc032, 5289, 8, 21);
     ...
     */
    public static top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite forJavaName(String javaName) {
        top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite result = INSTANCES.get(javaName);
        if (result == null) {
            top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite sample = new top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite(javaName);
            top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite canonical = INSTANCES.putIfAbsent(javaName, sample);
     ...
     */
    private static top.shixinzhang.sxframework.network.third.okhttp3.CipherSuite of(
