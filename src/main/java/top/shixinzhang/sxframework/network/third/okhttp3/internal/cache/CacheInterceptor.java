...
import top.shixinzhang.sxframework.network.third.okhttp3.internal.http.RealResponseBody;

import static java.net.HttpURLConnection.HTTP_NOT_MODIFIED;
import static java.util.concurrent.TimeUnit.MILLISECONDS;
import static top.shixinzhang.sxframework.network.third.okhttp3.internal.Util.closeQuietly;
import static top.shixinzhang.sxframework.network.third.okhttp3.internal.Util.discard;
...
public final class CacheInterceptor implements Interceptor {
  ...
  @Override public Response intercept(Chain chain) throws IOException {
    ...
    top.shixinzhang.sxframework.network.third.okhttp3.internal.cache.CacheStrategy strategy = new top.shixinzhang.sxframework.network.third.okhttp3.internal.cache.CacheStrategy.Factory(now, chain.request(), cacheCandidate).get();
